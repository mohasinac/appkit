...
export interface ActionMeta {
  ...
  authMessage?: string;
  /**
   * RBAC permission key required to use this action, checked by `useAuthGate`
   * against `SessionUser.permissions`.
   *
   * 🛑 Two preconditions, and BOTH must hold or the action is a guaranteed
   * denial that looks like a working permission check:
   *
   * 1. The value must be a **colon**-separated key that actually exists in
   *    `DEFAULT_ROLES` (`"admin:blog:read"`), not dot-separated. Three entries
   *    here carried dot-form keys (`"seller.payouts.request"`,
   *    `"seller.reviews.respond"`, `"user.account.delete"`) that match no role;
   *    they were removed 2026-08-27. Same family as the 182 guaranteed-403
   *    `permission:` lines deleted 2026-08-19.
   * 2. `SessionUser.permissions` must be populated for the acting user — today
   *    that happens only on the employee path
   *    (`_internal/server/features/auth/permissions.ts`). Neither
   *    `buildSessionUser` nor `fetchUserProfileFromServer` sets it, so for an
   *    ordinary buyer/seller this field denies unconditionally.
   *
   * Leave it unset unless you have verified both.
   */
...
export const ACTION_META: Record<ActionId, ActionMeta> = {
  ...
  [ACTION_ID.REQUEST_PAYOUT]:       { id: ACTION_ID.REQUEST_PAYOUT,       label: regLabel("STORE","request-payout","Request Payout"),       variant: "outline",   requiresAuth: true,  authMessage: "You need to be signed in to request a payout."  },
  [ACTION_ID.RESPOND_TO_REVIEW]:    { id: ACTION_ID.RESPOND_TO_REVIEW,    label: regLabel("STORE","reply-review","Respond to Review"),    variant: "outline",   requiresAuth: true,  authMessage: "You need to be signed in to respond to a review." },
  // ── User account actions ──────────────────────────────────────────────────
  ...
  [ACTION_ID.DELETE_ACCOUNT]:       { id: ACTION_ID.DELETE_ACCOUNT,       label: "Delete Account",       variant: "danger",    requiresAuth: true,  authMessage: "You need to be signed in to delete your account." },
};
...
export const ROW_ACTION_META: Record<RowActionId, RowActionMeta> = {
  ...
  [ROW_ACTION_ID.APPROVE]:   { id: ROW_ACTION_ID.APPROVE,   label: "Approve",        iconName: "Check",        requiresAuth: true, requiredRole: "admin" },
  [ROW_ACTION_ID.REJECT]:    { id: ROW_ACTION_ID.REJECT,    label: "Reject",         iconName: "X",            requiresAuth: true, requiredRole: "admin", destructive: true },
  [ROW_ACTION_ID.SUSPEND]:   { id: ROW_ACTION_ID.SUSPEND,   label: "Suspend",        iconName: "Ban",          requiresAuth: true, requiredRole: "admin", destructive: true, separator: true },
  [ROW_ACTION_ID.RESTORE]:   { id: ROW_ACTION_ID.RESTORE,   label: "Restore",        iconName: "RotateCcw",    requiresAuth: true, requiredRole: "admin" },
  ...
  [ROW_ACTION_ID.REFUND]:    { id: ROW_ACTION_ID.REFUND,    label: "Refund",         iconName: "RefreshCw",    requiresAuth: true, requiredRole: "admin", destructive: true, separator: true },
  ...
  [ROW_ACTION_ID.MARK_SHIPPED]:   { id: ROW_ACTION_ID.MARK_SHIPPED,   label: "Mark as Shipped",  iconName: "Truck",         requiresAuth: true, requiredRole: "admin"                         },
  [ROW_ACTION_ID.MARK_DELIVERED]: { id: ROW_ACTION_ID.MARK_DELIVERED, label: "Mark as Delivered", iconName: "PackageCheck",  requiresAuth: true, requiredRole: "admin"                         },
  [ROW_ACTION_ID.MARK_PAID]:      { id: ROW_ACTION_ID.MARK_PAID,      label: "Mark Paid",        iconName: "Banknote",      requiresAuth: true, requiredRole: "admin"                       },
  [ROW_ACTION_ID.MARK_RECEIVED]:  { id: ROW_ACTION_ID.MARK_RECEIVED,  label: "Mark Received",    iconName: "PackageCheck", requiresAuth: true, requiredRole: "admin"                       },
  [ROW_ACTION_ID.REVOKE]:         { id: ROW_ACTION_ID.REVOKE,         label: "Revoke",           iconName: "ShieldOff",     requiresAuth: true, requiredRole: "admin", destructive: true     },
  ...
  [ROW_ACTION_ID.FEATURE]:        { id: ROW_ACTION_ID.FEATURE,        label: "Toggle Featured",  iconName: "Star",          requiresAuth: true, requiredRole: "admin"                        },
...
export const DASHBOARD_QUICK_ACTION_META: Record<DashboardQuickActionId, DashboardQuickActionMeta> = {
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_ADD_PRODUCT]:  { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_ADD_PRODUCT,  label: "Add Product",    variant: "primary",  iconName: "Plus",         requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_ADD_USER]:     { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_ADD_USER,     label: "Add User",       variant: "outline",  iconName: "UserPlus",     requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_ADD_STORE]:    { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_ADD_STORE,    label: "Add Store",      variant: "outline",  iconName: "Store",        requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_ADD_COUPON]:   { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_ADD_COUPON,   label: "Manage Coupons", variant: "outline",  iconName: "Tag",          requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_ADD_EVENT]:    { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_ADD_EVENT,    label: "Add Event",      variant: "outline",  iconName: "Calendar",     requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_ADD_BLOG]:     { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_ADD_BLOG,     label: "New Post",       variant: "outline",  iconName: "FileText",     requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_ADD_FAQ]:      { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_ADD_FAQ,      label: "Add FAQ",        variant: "outline",  iconName: "HelpCircle",   requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_SETTINGS]:     { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_SETTINGS,     label: "Settings",       variant: "ghost",    iconName: "Settings",     requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_STORES]:       { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_STORES,       label: "Stores",         variant: "outline",  iconName: "Store",        requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_ORDERS]:       { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_ORDERS,       label: "Orders",         variant: "outline",  iconName: "ShoppingBag",  requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_PAYOUTS]:      { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_PAYOUTS,      label: "Payouts",        variant: "outline",  iconName: "Banknote",     requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_ANALYTICS]:    { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_ANALYTICS,    label: "Analytics",      variant: "outline",  iconName: "BarChart",     requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_EVENTS]:       { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_EVENTS,       label: "Events",         variant: "outline",  iconName: "Calendar",     requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_SUPPORT]:      { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_SUPPORT,      label: "Support Tickets", variant: "outline", iconName: "LifeBuoy",     requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_MODERATION]:   { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_MODERATION,   label: "Moderation",     variant: "outline",  iconName: "ShieldAlert",  requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_USERS]:        { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_USERS,        label: "Users",          variant: "outline",  iconName: "Users",        requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_CATEGORIES]:   { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_CATEGORIES,   label: "Categories",     variant: "outline",  iconName: "Tag",          requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_REVIEWS]:      { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_REVIEWS,      label: "Reviews",        variant: "outline",  iconName: "Star",         requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_FAQS]:         { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_FAQS,         label: "FAQs",           variant: "outline",  iconName: "HelpCircle",   requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_CAROUSEL]:     { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_CAROUSEL,     label: "Carousel",       variant: "outline",  iconName: "Layout",       requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_SECTIONS]:     { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_SECTIONS,     label: "Sections",       variant: "outline",  iconName: "Layers",       requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_BLOG]:         { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_BLOG,         label: "Blog",           variant: "outline",  iconName: "BookOpen",     requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_SCAMMERS]:     { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_SCAMMERS,     label: "Scammer Registry", variant: "outline", iconName: "AlertTriangle", requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_BUNDLES]:      { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_BUNDLES,      label: "Bundles",        variant: "outline",  iconName: "Package2",     requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_PRIZE_DRAWS]:  { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_PRIZE_DRAWS,  label: "Prize Draws",    variant: "outline",  iconName: "Gift",         requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.ADMIN_TESTER_CHECKLIST]: { id: DASHBOARD_QUICK_ACTION_ID.ADMIN_TESTER_CHECKLIST, label: "Tester Checklist", variant: "outline", iconName: "ClipboardCheck", requiresAuth: true, requiredRole: "admin" },
  [DASHBOARD_QUICK_ACTION_ID.SELLER_ADD_PRODUCT]: { id: DASHBOARD_QUICK_ACTION_ID.SELLER_ADD_PRODUCT, label: "List a Product", variant: "primary",  iconName: "Plus",         requiresAuth: true, requiredRole: "seller" },
  [DASHBOARD_QUICK_ACTION_ID.SELLER_ADD_COUPON]:  { id: DASHBOARD_QUICK_ACTION_ID.SELLER_ADD_COUPON,  label: "New Coupon",     variant: "outline",  iconName: "Tag",          requiresAuth: true, requiredRole: "seller" },
  ...
  [DASHBOARD_QUICK_ACTION_ID.SELLER_PAYOUT_REQ]:  { id: DASHBOARD_QUICK_ACTION_ID.SELLER_PAYOUT_REQ,  label: "Request Payout", variant: "outline",  iconName: "Banknote",     requiresAuth: true, requiredRole: "seller" },
