...
export function PrizeDrawItemsEditor({
  ...
  return (
    <Stack gap="md">
      ...
      {anyWon ? (
        <Div textSize="sm" className="border border-error/40" color="error" surface="danger-surface" padding="inlineSm" rounded="default">
      ...
      <Stack gap="md">
        {items.map((it, index) => {
          ...
          return (
            ...
            >
              {locked ? (
                <Row surface="overlay-xs" className="absolute inset-0 z-10 bg-[rgba(0,0,0,0.1)] dark: pointer-events-none" align="center" justify="center" rounded="lg">
