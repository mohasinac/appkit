...
function renderBundleSelectedChips(props: {
  ...
  return (
    <Row gap="sm" padding="sm" rounded="lg" surface="muted" border="default" wrap>
      {value.map((id) => {
        const meta = metadata[id];
        const label = meta?.title ?? id;
        return (
          <Row textSize="xs" key={id} gap="xs" align="center" paddingY="y-2xs" border="strong" padding="x-sm" surface="default" rounded="full">
