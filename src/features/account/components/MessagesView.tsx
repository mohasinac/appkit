  ...
  return (
    ...
    >
      ...
      {chatId ? (
        ...
        <Div className="hidden md:flex text-[var(--appkit-color-text-faint)] border border-dashed border-neutral-200 dark:border-neutral-700" align="center" justify="center" rounded="xl">
          {renderEmptyState?.() ?? (
