  ...
  return (
    ...
    >
      ...
      {chatId ? (
        ...
        <Div className="hidden md:flex text-[var(--appkit-color-text-faint)] border border-dashed border-[var(--appkit-color-border)]" align="center" justify="center" rounded="xl">
          {renderEmptyState?.() ?? (
