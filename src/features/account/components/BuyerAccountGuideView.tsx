...
const SECTIONS: AccountSection[] = [
  {
    ...
    content: (
      <Stack gap="3">
        ...
        <Div layout="grid" gap="4" textSize="sm" className="sm:grid-cols-2">
          <Div>
    ...
    content: (
      <>
        ...
        <Text className={`${GC.textMuted} mt-4`}>
          Read the full <TextLink href={String(ROUTES.PUBLIC.SCAMS)} weight="medium" className="text-[var(--appkit-color-primary)] underline hover:no-underline">Scam Registry →</TextLink> for all 27 documented scam types.
        </Text>
      </>
    ),
  },
  {
    ...
    content: (
      <Div layout="grid" gap="6" textSize="sm" className="sm:grid-cols-2">
        <Div>
          ...
          <TextLink href={String(ROUTES.PUBLIC.SCAMS)} size="sm" weight="medium" className="text-[var(--appkit-color-primary)] underline hover:no-underline">Go to Scam Registry →</TextLink>
        </Div>
        <Div>
          ...
          <TextLink href={String(ROUTES.USER.SUPPORT)} size="sm" weight="medium" className="text-[var(--appkit-color-primary)] underline hover:no-underline">Open Support Ticket →</TextLink>
        </Div>
      </Div>
    ),
  },
    ...
    <Stack className="max-w-3xl mx-auto" padding="b-2xl" gap="xl">
      <Section>
        <Row className="mb-2" align="center" gap="3">
          <Row className={`flex-shrink-0 w-10 h-10 ${GC.iconBg}`} align="center" justify="center" rounded="xl">
