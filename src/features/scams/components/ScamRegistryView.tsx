...
const CLS_ROW_CHEVRON = "h-4 w-4 shrink-0 transition group-hover:text-error text-[var(--appkit-color-text-faint)]";
  ...
  return (
    <Main>
      ...
      <Div className="border-b appkit-alert--warning" rounded="none">
        <Container padding="y-xs" size="xl" className="">
              ...
              <Row wrap gap="sm">
                ...
                {(query || scamType || sort !== "-createdAt") && (
                  <Link
                    ...
                    className="rounded-lg border border-[var(--appkit-color-border)] px-[var(--appkit-space-4)] py-[var(--appkit-space-2)] text-[length:var(--appkit-text-sm)] text-[var(--appkit-color-text-muted)] hover:bg-surface-hover transition-colors"
                  >
                    Clear
                  </Link>
                )}
