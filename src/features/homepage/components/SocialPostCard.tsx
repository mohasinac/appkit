...
function YouTubeCard({ post, showCaption }: { post: SocialPost; showCaption: boolean }) {
  ...
  return (
    <a
      ...
      className="group relative block aspect-video w-full overflow-hidden rounded-xl bg-zinc-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--appkit-color-youtube,#FF0000)]"
