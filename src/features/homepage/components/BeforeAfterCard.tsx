  ...
  return (
    <Div className={`border-border ${__O.hidden} border bg-card`} rounded="2xl" shadow="sm">
      ...
      >
        ...
        {/* Labels */}
        <Span size="xs" weight="medium" className="absolute top-3 left-3 z-10 bg-black/50 px-2.5 py-0.5 text-white" rounded="full">
          {beforeLabel}
        </Span>
        <Span size="xs" weight="medium" className="absolute top-3 right-3 z-10 bg-black/50 px-2.5 py-0.5 text-white" rounded="full">
          {afterLabel}
        </Span>
      </Div>
