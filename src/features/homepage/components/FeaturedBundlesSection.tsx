  ...
  return (
    <Section className={`py-10 ${className}`}>
      <Stack gap="md">
        ...
        {items.length === 0 ? (
          <Div className="border-dashed text-center dark:border-zinc-700" padding="y-3xl" rounded="xl" border="default">
...
function FeaturedBundleCard({ bundle, onBuyNow }: FeaturedBundleCardProps) {
  ...
  return (
    <Stack
      gap="none"
      className="bg-white dark:border-zinc-800 dark:bg-zinc-900" rounded="xl" border="default"
    >
