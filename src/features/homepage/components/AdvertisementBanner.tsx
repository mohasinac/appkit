...
const CLS_CTA_BTN_SM = "bg-[var(--appkit-color-surface)] bg-[var(--appkit-color-surface)] text-indigo-700 hover:bg-surface-hover font-semibold gap-[var(--appkit-space-1-5)] flex-shrink-0";
const CLS_CTA_BTN_LG = "bg-[var(--appkit-color-surface)] bg-[var(--appkit-color-surface)] text-indigo-700 hover:bg-surface-hover font-semibold shadow-lg gap-[var(--appkit-space-2)]";
      ...
      <Div className={CLS_CONTAINER}>
        ...
        >
          ...
          {compact ? (
            ...
            <Div className="relative z-10 w-full max-w-4xl mx-auto md:py-[4rem] text-left" paddingY="y-3xl" paddingX="x-lg">
              {tagLabel && (
              ...
              {subtitle && (
                <Text color="inverse" 
                  variant="none"
                  className="mb-10 max-w-2xl" mdSize="xl" size="base"
                >
                  {subtitle}
                </Text>
              )}
