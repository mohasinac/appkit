...
export function BottomNavLayout({
  ...
  return (
    <Nav
      ...
      className={`fixed bottom-0 left-0 right-0 lg:hidden z-40 bg-[color-mix(in_srgb,var(--appkit-color-bg)_90%,transparent)] backdrop-blur-md border-t border-[var(--appkit-color-border)] shadow-2xl pb-safe${className ? ` ${className}` : ""}`}
    >
