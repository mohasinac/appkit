    ...
    >
      ...
      <Div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1920px]">
        {(() => {
          ...
          // Secondary actions: shown inline on desktop, moved to a second bar on mobile.
          ...
          return (
            <>
              <Row justify="between" gap="none" className="h-14">
                ...
                {/* Right: primary actions always; secondary actions inline on desktop only */}
                <Row gap="xs">
                  <Div className="hidden md:contents">{secondaryActions}</Div>
                  {promotionsEl}
                  {themeBtn}
                  {hamburgerBtn}
                </Row>
              ...
              {/* Mobile-only second bar: secondary actions */}
              <Row
                justify="end"
                gap="xs"
                className="flex md:hidden h-12 border-t border-zinc-100 dark:border-slate-800"
              >
                {secondaryActions}
              </Row>
            </>
