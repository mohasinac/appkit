  ...
  const dashboardToggle =
    hasDashboardNav && onToggleDashboardNav ? (
      <button
        ...
        className="flex items-center justify-center w-8 h-8 rounded-lg text-[var(--appkit-color-text-muted)] hover:bg-[var(--appkit-color-surface)] hover:bg-[var(--appkit-color-surface-elevated)] hover:text-zinc-800 dark:hover:text-zinc-100 transition-colors"
      >
