...
export function SellerCouponsView({ renderHeader, children, ...props }: SellerCouponsViewProps) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="py-4 px-3 sm:px-4">
        ...
        <DataTable rows={rows} isLoading={isLoading} emptyLabel="No coupons found" />
      </div>
