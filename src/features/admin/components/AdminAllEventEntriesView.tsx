...
interface EntriesFilterDrawerProps {
  filterOpen: boolean;
...
export function AdminAllEventEntriesView({ children, ...props }: AdminAllEventEntriesViewProps) {
  ...
  const { rows, total, isLoading, errorMessage } = useAdminListingData<AdminEventEntriesResponse, EntryRow>({
