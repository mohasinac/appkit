...
export function AdminMediaView({ labels = {}, renderHeader, renderSearch, renderFilters, renderActiveFilters, renderTabs, renderTable, renderPagination, renderDrawer, renderModal, renderBulkActions, total = 0, isLoading = false, className = "" }: AdminMediaViewProps) {
