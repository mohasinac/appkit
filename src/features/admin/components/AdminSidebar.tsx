...
export function AdminSidebar({
  ...
  if (variant === "sidebar") {
    return (
      <>
        <aside
          className={`hidden md:flex flex-col shrink-0 border-r border-zinc-200 dark:border-slate-800 bg-white dark:bg-slate-950 sticky top-[var(--appkit-header-height,3.5rem)] self-start h-[calc(100vh-var(--appkit-header-height,3.5rem))] overflow-hidden transition-[width] duration-300 ${desktopOpen ? "w-72 border-r" : "w-0 border-r-0"}`}
        >
