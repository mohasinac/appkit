        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-5">
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              {[{ label: "All", value: "" }, { label: "Published", value: "true" }, { label: "Draft", value: "false" }].map((opt) => (
...
export function AdminFaqsView({ children, getRowHref, onBulkArchive, onBulkDelete, ...props }: AdminFaqsViewProps) {
  ...
  return (
    <div className="min-h-screen">
      <Heading level={1} className="sr-only">FAQs</Heading>
      <ListingToolbar
      ...
      <SideDrawer
        ...
        onClose={closePanel}
        title={isCreateOpen ? "Add FAQ" : "Edit FAQ"}
