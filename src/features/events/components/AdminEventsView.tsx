...
const STATUS_OPTIONS = ["All", "published", "draft", "active", "ended"];
const TYPE_OPTIONS = ["All", "contest", "giveaway", "sale", "poll", "survey", "flash-sale"];
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="py-4 px-3 sm:px-4">
        ...
        <DataTable rows={rows} isLoading={isLoading} emptyLabel="No events found" getRowHref={getRowHref as any} />
      </div>
