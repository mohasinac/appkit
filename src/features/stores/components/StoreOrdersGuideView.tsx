      ...
      <Div>
        ...
        <ul className="space-y-1 pl-5">
          <li className={LIST_DISC}>
            <strong className="text-[var(--appkit-color-text)]">Buyer</strong> — can self-cancel any time before the order reaches SHIPPED status.
          </li>
          <li className={LIST_DISC}>
            <strong className="text-[var(--appkit-color-text)]">Seller (you)</strong> — can cancel any time before SHIPPED (e.g. item found damaged during packaging).
          </li>
          <li className={LIST_DISC}>
            <strong className="text-[var(--appkit-color-text)]">LetItRip admin</strong> — can force-cancel at any status for policy violations or unresolved disputes.
          </li>
        </ul>
      </Div>
      <Div>
        ...
        <Text className="leading-relaxed">
          ...
          <strong className="text-[var(--appkit-color-text)]"> 3–7 business days</strong> depending on the payment method (UPI is usually 1–2 business days).
        </Text>
      </Div>
      <Div>
  ...
  return (
    <Div className={SECTION_BODY}>
      <Div>
        ...
        <Text className="leading-relaxed">
          Buyers can open a return request within the <strong className="text-[var(--appkit-color-text)]">return window</strong> after the order is marked DELIVERED.
  ...
  return (
    <Div className={SECTION_BODY}>
      <Div>
        ...
        <Text className="leading-relaxed">
          Auction winners have <strong className="text-[var(--appkit-color-text)]">48 hours</strong> from auction end to complete payment.
