    ...
    <Div className="space-y-4 text-sm text-[var(--appkit-color-text-muted)]">
      <Div>
        ...
        <Text className="leading-relaxed">
          The <strong className="text-[var(--appkit-color-text)]">starting bid</strong> is the minimum first bid a buyer can place.
          The <strong className="text-[var(--appkit-color-text)]">reserve price</strong> is the minimum price you are willing to accept —
  ...
  return (
    <Div className="space-y-4 text-sm text-[var(--appkit-color-text-muted)]">
      <Div>
        ...
        <Text className="leading-relaxed">
          Set a <strong className="text-[var(--appkit-color-text)]">deposit percentage</strong> (e.g. 20%). Buyers pay the deposit at checkout.
