...
const LISTING_TYPES = ["pre-order"] as const;
...
export async function StorePreOrdersPageView({ storeSlug, searchParams }: StorePreOrdersPageViewProps) {
  ...
  return <StorePreOrdersListing storeId={storeId} initialData={result ?? undefined} />;
}
