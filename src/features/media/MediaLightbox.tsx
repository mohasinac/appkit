...
function LightboxControlsBar({
  ...
  return (
    <Row className="gap-1.5 px-4 bg-black/85 backdrop-blur-sm shrink-0 border-t border-white/10" padding="y-sm" align="center" justify="center" wrap>
      {items.length > 1 && (
      ...
      <Span color="inverse" size="xs" className="/70 w-14 tabular-nums" align="center">
        {Math.round(zoom * 100)}%
      </Span>
      ...
      <Span color="inverse" size="xs" className="/60 w-12 tabular-nums" align="center">
...
function LightboxThumbnailStrip({
  ...
  return (
    <Row
      className="px-4 bg-black/70 backdrop-blur-sm overflow-x-auto shrink-0" padding="y-sm" justify="center" gap="sm"
