  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={t("cropTitle")} size="lg">
      <Stack gap="3">
        ...
        <Div
          ref={containerRef}
          className="relative w-full max-w-sm mx-auto aspect-square overflow-hidden cursor-move max-h-[280px] touch-none" surface="subtle" rounded="lg"
        ...
        >
          ...
          <Div className="absolute inset-0 pointer-events-none">
            ...
            <Row className="absolute inset-0" align="center" justify="center">
              <Div className="w-6 h-px" surface="default" />
              <Div className="absolute h-6 w-px" surface="default" />
            </Row>
          </Div>
        </Div>
