...
import { authored as a_admin__bug_hunter_rewards } from "./admin__bug-hunter-rewards";
...
import { authored as a_buying__image_tile_layout } from "./buying__image-tile-layout";
...
import { authored as a_buying__cart } from "./buying__cart";
...
import { authored as a_selling__sectionised_forms } from "./selling__sectionised-forms";
import { authored as a_selling__seller_shipping_payouts_setup } from "./selling__seller-shipping-payouts-setup";
...
import { authored as a_selling__product_upload_details } from "./selling__product-upload-details";
import { authored as a_selling__quick_add_minimum_details } from "./selling__quick-add-minimum-details";
...
export const AUTHORED_CASES: Record<string, AuthoredCase> = {
  ...
  ...a_selling__sectionised_forms,
  ...a_selling__seller_shipping_payouts_setup,
  ...a_selling__seller_orders,
  ...a_selling__seller_marketing_extras,
  ...a_selling__listing_a_product,
  ...a_selling__seller_listing_types,
  ...a_selling__product_upload_details,
  ...a_selling__quick_add_minimum_details,
