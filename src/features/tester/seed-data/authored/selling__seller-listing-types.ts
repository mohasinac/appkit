...
export const authored: Record<string, AuthoredCase> = {
  ...
  "checklist-selling-seller-listing-types-seller-coupon-auto-scoped-to-own-store": {
    ...
    steps: [
      ...
      "Sign out, sign in as admin@letitrip.in / TempPass123! (who owns store-letitrip-official), open /store/coupons, and check QASCOPE10 does not appear in that seller's coupons.",
  ...
  "checklist-selling-seller-listing-types-seller-bundles-crud": {
    ...
    steps: [
      ...
      "Attempt to add product-beyblade-burst-valkyrie, which belongs to a different store, as a member and read what happens.",
