...
const stagedAuctions: Partial<ProductDocument>[] = AUCTION_CYCLE_STAGGER_FRACTIONS.map((fraction, i) => {
  ...
  return withTokens({
    ...
    isSold: false,
    mainImage: seedPhoto(`auction-image-tester-sandbox-cycle-${i + 1}-20260101`, 900, 900),
    images: [seedPhoto(`auction-image-tester-sandbox-cycle-${i + 1}-20260101`, 900, 900)],
...
const buyoutAuctions: Partial<ProductDocument>[] = [
  ...
  withTokens({
    ...
    isSold: false,
    mainImage: seedPhoto(`auction-image-tester-sandbox-${f.key}-20260101`, 900, 900),
    images: [seedPhoto(`auction-image-tester-sandbox-${f.key}-20260101`, 900, 900)],
    status: PRODUCT_FIELDS.STATUS_VALUES.PUBLISHED,
    condition: PRODUCT_FIELDS.CONDITION_VALUES.NEW,
    listingType: "auction" as const,
    customFields: [],
...
const offerableProduct: Partial<ProductDocument> = withTokens({
  ...
  availableQuantity: 5,
  isSold: false,
  mainImage: seedPhoto("product-image-tester-offerable-20260101", 900, 900),
  images: [seedPhoto("product-image-tester-offerable-20260101", 900, 900)],
  status: PRODUCT_FIELDS.STATUS_VALUES.PUBLISHED,
  condition: PRODUCT_FIELDS.CONDITION_VALUES.NEW,
...
export const productsTesterSeedData: Partial<ProductDocument>[] = [
  ...
  withTokens({
    ...
    isSold: false,
    mainImage: seedPhoto("product-image-tester-standard-1-20260101", 900, 900),
    images: [seedPhoto("product-image-tester-standard-1-20260101", 900, 900)],
    status: PRODUCT_FIELDS.STATUS_VALUES.PUBLISHED,
    condition: PRODUCT_FIELDS.CONDITION_VALUES.NEW,
    listingType: "standard" as const,
    customFields: [],
  ...
  withTokens({
    ...
    availableQuantity: 10,
    isSold: false,
    mainImage: seedPhoto("product-image-tester-standard-2-20260101", 900, 900),
    images: [seedPhoto("product-image-tester-standard-2-20260101", 900, 900)],
    status: PRODUCT_FIELDS.STATUS_VALUES.PUBLISHED,
    condition: PRODUCT_FIELDS.CONDITION_VALUES.NEW,
    listingType: "standard" as const,
    customFields: [],
  ...
  withTokens({
    ...
    availableQuantity: 10,
    isSold: false,
    mainImage: seedPhoto("product-image-tester-standard-3-20260101", 900, 900),
    images: [seedPhoto("product-image-tester-standard-3-20260101", 900, 900)],
    status: PRODUCT_FIELDS.STATUS_VALUES.PUBLISHED,
    condition: PRODUCT_FIELDS.CONDITION_VALUES.NEW,
    listingType: "standard" as const,
    customFields: [],
  ...
  withTokens({
    ...
    availableQuantity: 0,
    isSold: true,
    mainImage: seedPhoto("product-image-tester-group-soldout-20260101", 900, 900),
    images: [seedPhoto("product-image-tester-group-soldout-20260101", 900, 900)],
    status: PRODUCT_FIELDS.STATUS_VALUES.PUBLISHED,
    condition: PRODUCT_FIELDS.CONDITION_VALUES.NEW,
    listingType: "standard" as const,
    customFields: [],
  ...
  withTokens({
    ...
    availableQuantity: 6,
    isSold: false,
    mainImage: seedPhoto("product-image-tester-crossstore-a-20260101", 900, 900),
    images: [seedPhoto("product-image-tester-crossstore-a-20260101", 900, 900)],
    status: PRODUCT_FIELDS.STATUS_VALUES.PUBLISHED,
    condition: PRODUCT_FIELDS.CONDITION_VALUES.NEW,
    listingType: "standard" as const,
    customFields: [],
  ...
  withTokens({
    ...
    availableQuantity: 6,
    isSold: false,
    mainImage: seedPhoto("product-image-tester-crossstore-b-20260101", 900, 900),
    images: [seedPhoto("product-image-tester-crossstore-b-20260101", 900, 900)],
    status: PRODUCT_FIELDS.STATUS_VALUES.PUBLISHED,
    condition: PRODUCT_FIELDS.CONDITION_VALUES.NEW,
    listingType: "standard" as const,
    customFields: [],
  ...
  withTokens({
    ...
    availableQuantity: 0,
    isSold: true,
    mainImage: seedPhoto("product-image-tester-standard-sold-20260101", 900, 900),
    images: [seedPhoto("product-image-tester-standard-sold-20260101", 900, 900)],
    status: PRODUCT_FIELDS.STATUS_VALUES.PUBLISHED,
    condition: PRODUCT_FIELDS.CONDITION_VALUES.NEW,
    listingType: "standard" as const,
    customFields: [],
  ...
  withTokens({
    ...
    isSold: true,
    mainImage: seedPhoto("auction-image-tester-sandbox-won-20260101", 900, 900),
    images: [seedPhoto("auction-image-tester-sandbox-won-20260101", 900, 900)],
    status: PRODUCT_FIELDS.STATUS_VALUES.PUBLISHED,
    condition: PRODUCT_FIELDS.CONDITION_VALUES.NEW,
    listingType: "auction" as const,
    customFields: [],
  ...
  withTokens({
    ...
    images: [seedPhoto("preorder-image-tester-sandbox-1-20260101", 900, 900)],
    mainImage: seedPhoto("preorder-image-tester-sandbox-1-20260101", 900, 900),
    isSold: false,
  ...
  withTokens({
    ...
    images: [seedPhoto("prizedraw-image-tester-sandbox-1-20260101", 900, 900)],
    mainImage: seedPhoto("prizedraw-image-tester-sandbox-1-20260101", 900, 900),
    isSold: false,
    stockQuantity: 3,
    availableQuantity: 3,
    customFields: [],
    ...
    prizeDrawItems: [
      { itemNumber: 1, title: "Test Prize — Grand", description: "Disposable test grand prize.", images: [seedPhoto("prizedraw-item-1-20260101", 600, 600)], condition: "new", estimatedValue: 500, isWon: false },
      { itemNumber: 2, title: "Test Prize — Runner-up", description: "Disposable test runner-up prize.", images: [seedPhoto("prizedraw-item-2-20260101", 600, 600)], condition: "new", estimatedValue: 150, isWon: false },
      { itemNumber: 3, title: "Test Prize — Consolation", description: "Disposable test consolation prize.", images: [seedPhoto("prizedraw-item-3-20260101", 600, 600)], condition: "new", estimatedValue: 20, isWon: false },
    ],
    createdAt: new Date(),
    updatedAt: new Date(),
  ...
  withTokens({
    ...
    status: PRODUCT_FIELDS.STATUS_VALUES.PUBLISHED,
    listingType: "prize-draw" as const,
    images: [seedPhoto("prizedraw-image-tester-sandbox-closed-20260101", 900, 900)],
    mainImage: seedPhoto("prizedraw-image-tester-sandbox-closed-20260101", 900, 900),
    isSold: true,
    stockQuantity: 0,
    availableQuantity: 0,
    customFields: [],
    ...
    prizeDrawItems: [
      { itemNumber: 1, title: "Test Prize — Grand", description: "Disposable test grand prize.", images: [seedPhoto("prizedraw-item-closed-1-20260101", 600, 600)], condition: "new", estimatedValue: 500, isWon: true },
      { itemNumber: 2, title: "Test Prize — Runner-up", description: "Disposable test runner-up prize.", images: [seedPhoto("prizedraw-item-closed-2-20260101", 600, 600)], condition: "new", estimatedValue: 150, isWon: true },
      { itemNumber: 3, title: "Test Prize — Consolation", description: "Disposable test consolation prize.", images: [seedPhoto("prizedraw-item-closed-3-20260101", 600, 600)], condition: "new", estimatedValue: 20, isWon: true },
    ],
    createdAt: new Date(),
    updatedAt: new Date(),
  } as unknown as Partial<ProductDocument>),
  withTokens({
    ...
    images: [seedPhoto("classified-image-tester-sandbox-1-20260101", 900, 900)],
    mainImage: seedPhoto("classified-image-tester-sandbox-1-20260101", 900, 900),
    isSold: false,
    stockQuantity: 1,
    availableQuantity: 1,
    customFields: [],
  ...
  withTokens({
    ...
    images: [seedPhoto("digitalcode-image-tester-sandbox-1-20260101", 900, 900)],
    mainImage: seedPhoto("digitalcode-image-tester-sandbox-1-20260101", 900, 900),
    isSold: false,
    stockQuantity: 10,
    availableQuantity: 10,
    customFields: [],
  ...
  withTokens({
    ...
    images: [seedPhoto("live-image-tester-sandbox-1-20260101", 900, 900)],
    mainImage: seedPhoto("live-image-tester-sandbox-1-20260101", 900, 900),
    ...
    video: {
      ...
      thumbnailUrl: seedPhoto("live-video-thumb-tester-sandbox-1-20260101", 800, 450),
      duration: 14,
    },
    isSold: false,
    stockQuantity: 1,
  ...
  withTokens({
    ...
    availableQuantity: 5,
    isSold: false,
    mainImage: seedPhoto("art-image-tester-sandbox-1-20260101", 900, 900),
    images: [seedPhoto("art-image-tester-sandbox-1-20260101", 900, 900)],
    status: PRODUCT_FIELDS.STATUS_VALUES.PUBLISHED,
    condition: PRODUCT_FIELDS.CONDITION_VALUES.NEW,
  ...
  withTokens({
    ...
    isSold: false,
    mainImage: seedPhoto("stickers-image-tester-sandbox-1-20260101", 900, 900),
    images: [seedPhoto("stickers-image-tester-sandbox-1-20260101", 900, 900)],
    status: PRODUCT_FIELDS.STATUS_VALUES.PUBLISHED,
    condition: PRODUCT_FIELDS.CONDITION_VALUES.NEW,
