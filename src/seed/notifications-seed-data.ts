...
const notificationRecords: Partial<NotificationDocument>[] = [
  ...
  {
    id: "notif-rohit-catalogue-stale-001",
    userId: "user-rohit-collector",
    type: NOTIFICATION_FIELDS.TYPE_VALUES.CATALOGUE_IMAGES_STALE,
    priority: "normal",
    title: "Refresh your catalogue photos",
    message: "Photos for your vintage Hot Wheels are getting old - refresh them within 14 days or you won't be able to list it.",
    isRead: false,
    relatedId: "mycatalog-user-rohit-collector-vintage-hotwheels-20260801-a1b2c3",
