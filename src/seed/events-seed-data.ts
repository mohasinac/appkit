...
export const eventsSeedData: EventDocument[] = [
  ...
  // ── 9. ACTIVE — Lottery: Pokémon Number Draw (July 2026) ─────────────────
  {
    ...
    lotteryConfig: {
      ...
      maxPullsPerUser: 1,
      slots: [
        { slotNumber: 1,  name: "Charizard Base Set Holo",          priceInPaise: 5000_00, weight: 1,  isBooked: true,  bookedByUserId: "user-ravi-k",   bookedByDisplayName: "Ravi K",   bookedByUserLotteryNumber: 1 },
        { slotNumber: 2,  name: "Blastoise Base Set Holo",          priceInPaise: 3000_00, weight: 33, isBooked: true,  bookedByUserId: "user-priya-s",  bookedByDisplayName: "Priya S",  bookedByUserLotteryNumber: 2 },
        { slotNumber: 3,  name: "Venusaur Base Set Holo",           priceInPaise: 2500_00, weight: 40, isBooked: true,  bookedByUserId: "user-arjun-m",  bookedByDisplayName: "Arjun M",  bookedByUserLotteryNumber: 3 },
        { slotNumber: 4,  name: "Pikachu Surfing Promo",            priceInPaise: 1500_00, weight: 66, isBooked: true,  bookedByUserId: "user-sneha-p",  bookedByDisplayName: "Sneha P",  bookedByUserLotteryNumber: 4 },
        { slotNumber: 5,  name: "Mewtwo Base Set Holo",             priceInPaise: 2000_00, weight: 50, isBooked: true,  bookedByUserId: "user-vikram-r", bookedByDisplayName: "Vikram R", bookedByUserLotteryNumber: 5 },
        { slotNumber: 6,  name: "Gengar First Ed. Fossil",          priceInPaise: 3500_00, weight: 28, isBooked: false },
        { slotNumber: 7,  name: "Alakazam Base Set Holo",           priceInPaise: 800_00,  weight: 93, isBooked: false },
        { slotNumber: 8,  name: "Machamp 1st Ed. Base Set",         priceInPaise: 400_00,  weight: 99, isBooked: false },
        { slotNumber: 9,  name: "Clefairy Base Set Holo",           priceInPaise: 600_00,  weight: 95, isBooked: false },
        { slotNumber: 10, name: "Chansey Base Set Holo",            priceInPaise: 700_00,  weight: 94, isBooked: false },
        { slotNumber: 11, name: "Ninetales Base Set Holo",          priceInPaise: 1000_00, weight: 80, isBooked: false },
        { slotNumber: 12, name: "Scyther Jungle Holo",              priceInPaise: 500_00,  weight: 97, isBooked: false },
        { slotNumber: 13, name: "Gyarados Base Set Holo",           priceInPaise: 1200_00, weight: 76, isBooked: false },
        { slotNumber: 14, name: "Lapras Fossil Holo",               priceInPaise: 900_00,  weight: 88, isBooked: false },
        { slotNumber: 15, name: "Zapdos Fossil Holo",               priceInPaise: 2200_00, weight: 45, isBooked: false },
        { slotNumber: 16, name: "Articuno Fossil Holo",             priceInPaise: 2000_00, weight: 50, isBooked: false },
        { slotNumber: 17, name: "Moltres Fossil Holo",              priceInPaise: 1800_00, weight: 55, isBooked: false },
        { slotNumber: 18, name: "Dragonite Base Set Holo",          priceInPaise: 4000_00, weight: 20, isBooked: false },
        { slotNumber: 19, name: "Snorlax Jungle Holo",              priceInPaise: 600_00,  weight: 95, isBooked: false },
        { slotNumber: 20, name: "Jolteon Jungle Holo",              priceInPaise: 700_00,  weight: 94, isBooked: false },
        { slotNumber: 21, name: "Flareon Jungle Holo",              priceInPaise: 700_00,  weight: 94, isBooked: false },
        { slotNumber: 22, name: "Vaporeon Jungle Holo",             priceInPaise: 700_00,  weight: 94, isBooked: false },
        { slotNumber: 23, name: "Espeon Neo Discovery Holo",        priceInPaise: 800_00,  weight: 93, isBooked: false },
        { slotNumber: 24, name: "Umbreon Neo Discovery Holo",       priceInPaise: 1000_00, weight: 80, isBooked: false },
        { slotNumber: 25, name: "Lugia Neo Genesis Holo",           priceInPaise: 4500_00, weight: 10, isBooked: false },
      ],
