...
const _kaibaSinglesSeedData: Partial<ProductDocument>[] = [
  ...
  },
  {
    ...
    availableQuantity: 4,
    isSold: false,
    mainImage: seedExtMedia(`https://images.ygoprodeck.com/images/cards/${CARD_IDS.gaiaFierceKnight}.jpg`),
    images: [seedExtMedia(`https://images.ygoprodeck.com/images/cards/${CARD_IDS.gaiaFierceKnight}.jpg`)],
    status: PRODUCT_FIELDS.STATUS_VALUES.PUBLISHED,
    condition: PRODUCT_FIELDS.CONDITION_VALUES.USED,
    storeId: "store-kaiba-corp-cards",
    storeName: "Kaiba Corp Card Vault",
  ...
  },
  {
    ...
    availableQuantity: 2,
    isSold: false,
    mainImage: seedExtMedia(`https://images.ygoprodeck.com/images/cards/${CARD_IDS.elementalHeroNeos}.jpg`),
    images: [seedExtMedia(`https://images.ygoprodeck.com/images/cards/${CARD_IDS.elementalHeroNeos}.jpg`)],
    status: PRODUCT_FIELDS.STATUS_VALUES.PUBLISHED,
    condition: PRODUCT_FIELDS.CONDITION_VALUES.NEW,
    storeId: "store-kaiba-corp-cards",
    storeName: "Kaiba Corp Card Vault",
