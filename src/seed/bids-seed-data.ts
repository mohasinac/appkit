...
export const bidsSeedData: Partial<BidDocument>[] = [
  ...
  // Bid 1 — Ash opens the bidding
  {
    ...
    userEmail: "ash.ketchum@letitrip.in",
    bidAmount: 299999,
    currency: _CURRENCY,
    status: "outbid",
    isWinning: false,
  ...
  // Bid 2 — Gary counters
  {
    ...
    userName: "Gary Oak",
    userEmail: "gary.oak@letitrip.in",
    bidAmount: 304999,
    currency: _CURRENCY,
    status: "outbid",
    isWinning: false,
  ...
  // Bid 3 — Professor Oak enters
  {
    ...
    userEmail: "dawn.sinnoh@letitrip.in",
    bidAmount: 309999,
    currency: _CURRENCY,
    status: "outbid",
    isWinning: false,
  ...
  // Bid 7 — Sabrina joins the auction
  {
    ...
    userName: "May (Hoenn)",
    userEmail: "may.hoenn@letitrip.in",
    bidAmount: 329999,
    currency: _CURRENCY,
    status: "outbid",
    isWinning: false,
  ...
  // Bid 10 — Brock wants the crown jewel too
  {
    ...
    userEmail: "brock.pewter@letitrip.in",
    bidAmount: 344999,
    currency: _CURRENCY,
    status: "outbid",
    isWinning: false,
