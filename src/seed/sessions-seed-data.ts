...
export const sessionsSeedData: SessionDocument[] = [
  ...
  // ── Active: Jane Smith — Safari iOS ─────────────────────────────────────
  {
    ...
    location: { country: _locale.countryName, city: "Delhi" },
    createdAt: daysAgo(9),
    lastActivity: daysAgo(8),
  ...
  // ── Active: Priya Sharma — Chrome iPad (Tablet) ─────────────────────────
  {
    ...
    location: { country: _locale.countryName, city: "Hyderabad" },
    createdAt: daysAgo(10),
  ...
  // ── Active: Artisan Crafts Co. seller — Edge Windows Desktop ─────────────
  {
    ...
    location: { country: _locale.countryName, city: "Jaipur" },
    createdAt: daysAgo(12),
    lastActivity: daysAgo(9),
  ...
  // Tests: admin session list, cleanup queries, session expiry UI badge
  {
    ...
    location: { country: _locale.countryName, city: "Bangalore" },
  ...
  // ── Expired: Raj Patel — Chrome Android (natural expiry) ─────────────────
  {
    ...
    location: { country: _locale.countryName, city: "Ahmedabad" },
  ...
  // ── Active: Vikram Nair — Chrome Mobile ──────────────────────────────────
  {
    ...
    location: { country: _locale.countryName, city: "Kochi" },
    createdAt: daysAgo(9),
    lastActivity: daysAgo(4),
    expiresAt: daysAhead(19),
    isActive: true,
  ...
  // ── Active: Ananya Bose — Safari iOS ─────────────────────────────────────
  {
    ...
    location: { country: _locale.countryName, city: "Kolkata" },
  ...
  // ── Active: Ravi Kumar — Chrome Android ──────────────────────────────────
  {
    ...
    location: { country: _locale.countryName, city: "Chandigarh" },
    createdAt: daysAgo(12),
    lastActivity: daysAgo(4),
    expiresAt: daysAhead(16),
    isActive: true,
  ...
  // ── Active: Sneha Gupta — Firefox Desktop ────────────────────────────────
  {
    ...
    location: { country: _locale.countryName, city: "Lucknow" },
    createdAt: daysAgo(9),
    lastActivity: daysAgo(4),
    expiresAt: daysAhead(19),
    isActive: true,
