...
function attachCopyButtons(container: HTMLDivElement) {
  container.querySelectorAll<HTMLElement>("pre").forEach((pre) => {
    ...
    btn.style.cssText =
      ...
      "color:#e2e8f0;cursor:pointer;line-height:1.6;user-select:none;transition:background .15s;"; // audit-hex-tokens-ok: DOM-injected cssText string; CSS vars require getPropertyValue() and can't be used in style.cssText assignment
