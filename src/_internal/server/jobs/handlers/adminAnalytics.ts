/**
 * HTTPS callable handler: aggregate admin analytics. Returns 12-month order
 * totals + monthly breakdown + top-5 products by revenue.
 */
...
export const adminAnalyticsHandler: CallableHandler<void, AdminAnalyticsResult> = async (
  _input,
  ctx,
) => {
